...
const MagiPage = () => {
    return (
        <section className="magi-page page-container">
            ...
            <p className="text-base text-gray-700 leading-relaxed mt-4">Go back to the beginning of the chapter to see who these wise men are:</p>
            <Quote>
            ...
            <ul className="list-disc pl-6 space-y-4 text-gray-800">
                <li>
                    <p className="text-base text-gray-700 leading-relaxed"><strong><em>Chaldeans</em></strong> - an advisory leadership title</p>
                </li>
                <li>
            ...
            <p className="text-base text-gray-700 leading-relaxed mt-4">The practices of these groups probably overlapped extensively. Daniel referred to them generally as "wise men" (Daniel 2:12-14, 18, 24[2x], 48; 4:6, 18; 5:7-8, 15)</p>
        </section>
    )
}
